...
namespace Video_Rental_Store
{
    public partial class DVD : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "moviesDataSet1.DVDmovie". При необходимости она может быть перемещена или удалена.
            this.dVDmovieTableAdapter.Fill(this.moviesDataSet1.DVDmovie);
