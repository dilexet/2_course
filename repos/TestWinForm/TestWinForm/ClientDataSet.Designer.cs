...
namespace TestWinForm {
    ...
    public partial class ClientDataSet : global::System.Data.DataSet {
        ...
        public partial class clientDataTable : global::System.Data.TypedTableBase<clientRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public clientRow AddclientRow(string surname, string name, string phone, string street, int house, int apartament) {
        ...
        public partial class clientRow : global::System.Data.DataRow {
            ...
            public string street {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'street\' в таблице \'client\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public int house {
                get {
                    try {
                        return ((int)(this[this.tableclient.houseColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'house\' в таблице \'client\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public int apartament {
                get {
                    try {
                        return ((int)(this[this.tableclient.apartamentColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'apartament\' в таблице \'client\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableclient.apartamentColumn] = value;
                }
            }
            ...
            public bool IshouseNull() {
                return this.IsNull(this.tableclient.houseColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SethouseNull() {
                this[this.tableclient.houseColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public bool IsapartamentNull() {
                return this.IsNull(this.tableclient.apartamentColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetapartamentNull() {
                this[this.tableclient.apartamentColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace TestWinForm.ClientDataSetTableAdapters {
    ...
    public partial class clientTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `client` WHERE ((`id` = ?) AND ((? = 1 AND `surname` IS NULL) OR (`surname` = ?)) AND ((? = 1 AND `name` IS NULL) OR (`name` = ?)) AND ((? = 1 AND `phone` IS NULL) OR (`phone` = ?)) AND ((? = 1 AND `street` IS NULL) OR (`street` = ?)) AND ((? = 1 AND `house` IS NULL) OR (`house` = ?)) AND ((? = 1 AND `apartament` IS NULL) OR (`apartament` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `client` (`surname`, `name`, `phone`, `street`, `house`, `apartament`" +
                ") VALUES (?, ?, ?, ?, ?, ?)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TestWinForm.Properties.Settings.Default.ClientConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `id`, `surname`, `name`, `phone`, `street`, `house`, `apartament` FROM `cl" +
                "ient`";
