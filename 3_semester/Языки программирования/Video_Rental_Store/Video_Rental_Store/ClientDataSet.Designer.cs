...
namespace Video_Rental_Store {
    ...
    public partial class ClientDataSet : global::System.Data.DataSet {
        ...
        public partial class customerDataTable : global::System.Data.TypedTableBase<customerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public customerRow AddcustomerRow(string surname, string name, string phone, string street, int house, int apartament) {
...
namespace Video_Rental_Store.ClientDataSetTableAdapters {
    ...
    public partial class customerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `customer` WHERE ((`id` = ?) AND ((? = 1 AND `surname` IS NULL) OR (`surname` = ?)) AND ((? = 1 AND `name` IS NULL) OR (`name` = ?)) AND ((? = 1 AND `phone` IS NULL) OR (`phone` = ?)) AND ((? = 1 AND `street` IS NULL) OR (`street` = ?)) AND ((? = 1 AND `house` IS NULL) OR (`house` = ?)) AND ((? = 1 AND `apartament` IS NULL) OR (`apartament` = ?)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `customer` SET `surname` = ?, `name` = ?, `phone` = ?, `street` = ?, `house` = ?, `apartament` = ? WHERE ((`id` = ?) AND ((? = 1 AND `surname` IS NULL) OR (`surname` = ?)) AND ((? = 1 AND `name` IS NULL) OR (`name` = ?)) AND ((? = 1 AND `phone` IS NULL) OR (`phone` = ?)) AND ((? = 1 AND `street` IS NULL) OR (`street` = ?)) AND ((? = 1 AND `house` IS NULL) OR (`house` = ?)) AND ((? = 1 AND `apartament` IS NULL) OR (`apartament` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `id`, `surname`, `name`, `phone`, `street`, `house`, `apartament` FROM `cu" +
                "stomer`";
        ...
        public virtual int Delete(int Original_id, string Original_surname, string Original_name, string Original_phone, string Original_street, global::System.Nullable<int> Original_house, global::System.Nullable<int> Original_apartament) {
        ...
        public virtual int Insert(string surname, string name, string phone, string street, global::System.Nullable<int> house, global::System.Nullable<int> apartament) {
            if ((surname == null)) {
        ...
        public virtual int Update(string surname, string name, string phone, string street, global::System.Nullable<int> house, global::System.Nullable<int> apartament, int Original_id, string Original_surname, string Original_name, string Original_phone, string Original_street, global::System.Nullable<int> Original_house, global::System.Nullable<int> Original_apartament) {
            if ((surname == null)) {
            ...
            if ((Original_apartament.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((int)(Original_apartament.Value));
            }
            else {
